...
public class Constants {
	...
	//Arm
		...
		public static final double ARM_LOW_POS = .569; //change this one
		public static final double ARM_ING_POS = ARM_LOW_POS - 0.014; //don't change
		public static final double ARM_DEF_POS = ARM_LOW_POS - .146; //don't change
		public static final double ARM_SHOOT_POS = ARM_LOW_POS - .441;//don't change
		public static final double ARM_AUTO_SHOOT_POS = ARM_LOW_POS - .331;//don't change
		...
		public static final double ARM_DEF_P = 3;
