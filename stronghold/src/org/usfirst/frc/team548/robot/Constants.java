...
public class Constants {
	...
	//Drivetrain motors
		public static final int DT_TALON_POS_LEFT_FRONT = 8;//1 //left encoder location
		public static final int DT_TALON_POS_LEFT_MID = 7;//2
		public static final int DT_TALON_POS_LEFT_BACK = 6;//3
		public static final int DT_TALON_POS_RIGHT_FRONT = 0;//10
		public static final int DT_TALON_POS_RIGHT_MID = 1;//11
		public static final int DT_TALON_POS_RIGHT_BACK = 2; //12 //right encoder location		
	...
	//Arm
		...
		public static final int RIGHT_ARM_TALON_POS = 10;//7
		public static final double ARM_POWER_COEFFICIENT = 0.75;
		public static final double ARM_LOW_POS = .946; //change this one
	...
	//Shooter
		public static final int SHOOTING_TALON_POS_1 = 3;//5 practice
	...
	//Ingesting
		public static final int INGESTING_TALON_POS = 5;//8
